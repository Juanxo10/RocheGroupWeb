...
function Nosotros() {
  useSeo({
    title: 'Nosotros',
    description:
      'Conoce a RovidionGroup: un equipo comprometido con la innovación, la calidad y la transparencia en cada proyecto digital.',
  })
              ...
              {projects.map((project, i) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-headline-md text-xl mt-2 mb-3 text-on-background">
                      {project.title}
                    </h3>
