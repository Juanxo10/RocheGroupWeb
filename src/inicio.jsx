              ...
              {projects.map((project, i) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <span className="inline-flex items-center gap-1 text-primary dark:text-secondary-container font-label-md text-label-md group-hover:gap-2 transition-all duration-300">
                      Ver detalles
